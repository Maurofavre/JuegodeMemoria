...
namespace JuegodeMemoria
{
    public partial class Form4 : Form
    {
        ...
        private string connectionString = @"Data Source=C:\Users\mauro\OneDrive\Desktop\hoy\JuegoDeMemoria\JuegodeMemoria\JuegodeMemoria\DBMemoryGame.db;Version=3;";
        ...
        private void label_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (attempts4 > 7 && attempts4 < 9)
                {
                    SoundPlayer player = new SoundPlayer();
                    player.SoundLocation = @"C:\Users\mauro\OneDrive\Desktop\grito.wav";
                    player.Play();
        ...
        private void CheckForWinner()
        {
            ...
            SoundPlayer player = new SoundPlayer();
            player.SoundLocation = @"C:\Users\mauro\OneDrive\Desktop\fin.wav";
            player.Play();
